...
- **Committed punctuation guard**: `src/app/glossary.test.ts` asserts no em dash in any dictionary headword or definition (CONTEXT.md's punctuation style, enforced where structural copy lives). Restructure the sentence; never weaken the assertion.
