...
def test_validate_minimal_snapshot_passes():
    meta, shots, league = dp.validate_snapshot(minimal_snapshot())
...
def _type_zone_mismatch(s):
    _shot_rs(s)["rowSet"][0][dp.SHOT_HEADERS.index("SHOT_TYPE")] = "3PT Field Goal"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (_type_zone_mismatch, "inconsistent with zone"),
...
def test_golden_matches_derive_output():
    snapshot = load_truncated()
    meta, shots, league = dp.validate_snapshot(snapshot)
